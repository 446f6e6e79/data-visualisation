...
\begin{enumerate}
  ...
  \item \textbf{Rideable preferences}---trends in rideable type usage (classic vs.\@ electric) across different contexts.
\end{enumerate}
...
Those informations are the most relevant angles we aim to explore, as they directly inform operational decisions and strategic planning for the company.
