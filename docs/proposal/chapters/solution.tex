...
Regarding the update frequency, we expect the dashboard to be refreshed automatically on a regular basis, since the data are continuously collected.
...
Regarding framing, we expose all available features, giving users the freedom to explore in depth and draw their own conclusions.
